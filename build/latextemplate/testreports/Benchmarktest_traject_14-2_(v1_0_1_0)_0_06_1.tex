...
De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest \textit{traject 14-2} per toetsspoor (\autoref{sec:3:pertoetsspoor}) en per traject (\autoref{sec:3:pertraject}).
...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
		\caption{Resultaat per toetsspoor voor benchmarktest traject 14-2.	\label{tab:3:ResultatenPerToetsspoor}}\\
		\hline \T
