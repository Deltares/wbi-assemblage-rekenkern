\section{Benchmarktest: Benchmarktest\_traject 13-3}
	\label{ch:benchmarktTest2}
In deze paragraaf wordt het resultaat beschreven van de benchmarktest \textit{Benchmarktest\_traject 13-3}. De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest per toetsspoor (\autoref{sec:2:pertoetsspoor}) en per traject (\autoref{sec:2:pertraject}).
...
\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
   ...
   Grasbekleding erosie kruin en binnentalud & GEKB & 1 & \xmark & \cmark & \cmark & \cmark & \cmark & \xmark & \xmark & \cmark \B \\ \T
   ...
   Hoogte kunstwerk & HTKW & 1 & \xmark & \cmark & \cmark & \cmark & \cmark & \xmark & \xmark & \cmark \B \\ \T
...
\begin{longtable}[]{p{0.5cm} l}
	\endhead
	\T
	\xmark & Bepaling toetsoordeel voor de gecombineerde toetssporen in de groepen 1 en 2. \B \\ \T
	\xmark & Bepaling toetsoordeel voor de gecombineerde toetssporen in de groepen 1 en 2 (tijdelijk). \B \\ \T
