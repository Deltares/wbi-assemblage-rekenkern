...
De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest \textit{traject 13-3} per toetsspoor (\autoref{sec:2:pertoetsspoor}) en per traject (\autoref{sec:2:pertraject}).
...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
		\caption{Resultaat per toetsspoor voor benchmarktest traject 13-3.	\label{tab:2:ResultatenPerToetsspoor}}\\
		\hline \T
