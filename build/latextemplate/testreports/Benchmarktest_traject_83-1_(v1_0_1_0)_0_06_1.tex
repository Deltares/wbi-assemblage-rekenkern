...
De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest \textit{traject 83-1} per toetsspoor (\autoref{sec:7:pertoetsspoor}) en per traject (\autoref{sec:7:pertraject}).
...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
		\caption{Resultaat per toetsspoor voor benchmarktest traject 83-1.	\label{tab:7:ResultatenPerToetsspoor}}\\
		\hline \T
