...
De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest \textit{traject 36-2} per toetsspoor (\autoref{sec:6:pertoetsspoor}) en per traject (\autoref{sec:6:pertraject}).
...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
		\caption{Resultaat per toetsspoor voor benchmarktest traject 36-2.	\label{tab:6:ResultatenPerToetsspoor}}\\
		\hline \T
