\section{Benchmarktest: traject 36-2}
	\label{ch:benchmarktTest6}
In deze paragraaf wordt het resultaat beschreven van de benchmarktest \textit{traject 36-2}. De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest per toetsspoor (\autoref{sec:6:pertoetsspoor}) en per traject (\autoref{sec:6:pertraject}).

\subsection{Assemblage per toetsspoor}
	\label{sec:6:pertoetsspoor}
