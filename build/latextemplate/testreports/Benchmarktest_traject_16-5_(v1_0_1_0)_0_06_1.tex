...
De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest \textit{traject 16-5} per toetsspoor (\autoref{sec:4:pertoetsspoor}) en per traject (\autoref{sec:4:pertraject}).
...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
		\caption{Resultaat per toetsspoor voor benchmarktest traject 16-5.	\label{tab:4:ResultatenPerToetsspoor}}\\
		\hline \T
