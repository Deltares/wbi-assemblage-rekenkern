...
In deze paragraaf wordt het resultaat beschreven van de benchmarktest \textit{traject INNW\_22-1}. De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest per toetsspoor (\autoref{sec:4:pertoetsspoor}) en per traject (\autoref{sec:4:pertraject}).
...
\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
	...
	\hline \T
		Toetsspoor & Code & Groep & \rotatebox{90}{Eenvoudige toets} & \rotatebox{90}{Gedetailleerde toets} & \rotatebox{90}{Toets op maat} & \rotatebox{90}{Toetsoordeel per vak} & \rotatebox{90}{Toetsoordeel per traject} & \rotatebox{90}{Toetsoordeel per traject} \rotatebox{90}{(tijdelijk)} & \rotatebox{90}{Toetsoordeel per deelvak} \rotatebox{90}{(met grootste gemene deler) } & \rotatebox{90}{Bepaling} \rotatebox{90}{categoriegrenzen}\B \\
	\endhead
	\hline\T
