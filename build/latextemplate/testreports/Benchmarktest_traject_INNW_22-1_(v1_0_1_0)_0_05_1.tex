...
De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest \textit{traject INNW\_22-1} per toetsspoor (\autoref{sec:8:pertoetsspoor}) en per traject (\autoref{sec:8:pertraject}).
...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
		\caption{Resultaat per toetsspoor voor benchmarktest traject INNW\_22-1.	\label{tab:8:ResultatenPerToetsspoor}}\\
		\hline \T
