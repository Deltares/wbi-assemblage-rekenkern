\section{Benchmarktest: Benchmarktest\_traject INNW\_12-2}
	\label{ch:benchmarktTest4}
In deze paragraaf wordt het resultaat beschreven van de benchmarktest \textit{Benchmarktest\_traject INNW\_12-2}. De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest per toetsspoor (\autoref{sec:4:pertoetsspoor}) en per traject (\autoref{sec:4:pertraject}).
...
\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
   ...
   Piping & STPH & 2 & \cmark & \cmark & \cmark & \xmark & \xmark & \cmark & \cmark & \cmark \B \\ \T
   ...
   Hoogte kunstwerk & HTKW & 1 & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark \B \\ \T
   Betrouwbaarheid sluiting kunstwerk & BSKW & 1 & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark \B \\ \T
   Piping bij kunstwerk & PKW & 4 & \nmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark \B \\ \T
   Sterkte en stabiliteit punconstructies & STKWp & 1 & \cmark & \xmark & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark \B \\ \T
   Sterkte en stabiliteit langsconstructies & STKWl & 4 & \nmark & \cmark & \nmark & \cmark & \cmark & \cmark & \cmark & \xmark \B \\ \T
...
\begin{longtable}[]{p{0.5cm} l}
	\endhead
	\T
	\xmark & Bepaling van de gecombineerde deelvakken. \B \\ \T
