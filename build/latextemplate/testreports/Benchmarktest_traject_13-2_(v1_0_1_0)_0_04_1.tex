...
De volgende paragrafen geven een overzicht van de resultaten van het doorlopen van de benchmarktest \textit{traject 13-2} per toetsspoor (\autoref{sec:1:pertoetsspoor}) en per traject (\autoref{sec:1:pertraject}).
...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l | c c c c c c c c@{}}
		\caption{Resultaat per toetsspoor voor benchmarktest traject 13-2.	\label{tab:1:ResultatenPerToetsspoor}}\\
		\hline \T
