...
\begin{footnotesize}
	\begin{longtable}[]{@{}l l l l | c c c c c c c c c c c@{}}
		\caption{Resultaat per faalmechanisme voor benchmarktest $BenchmarkTestName$.	\label{tab:$Order$:ResultatenPerFaalmechanisme}}\\
		\hline \T
			Faalmechanisme & Code & \rotatebox{90}{Lengte-effect binnen vak } & \rotatebox{90}{Methode } & \rotatebox{90}{Test 0-2: Faalkans per vak } & \rotatebox{90}{Test 0-2: Duiding per vak } & \rotatebox{90}{Test 1-1: Faalkans per faalmechanisme } & \rotatebox{90}{Test 1-1: Faalkans per faalmechanisme } \rotatebox{90}{(tussentijds)} & \rotatebox{90}{Test 1-2: Theoretische grenzen } \rotatebox{90}{per faalmechanisme} & \rotatebox{90}{Test 1-2: Theoretische grenzen } \rotatebox{90}{per faalmechanisme (tussentijds)} & \rotatebox{90}{Test 3-2: Duidingsklasse per deelvak } \rotatebox{90}{(vak met grootst gemene deler) } \B \\
		\endhead
		\hline\T
