...
namespace Assembly.Kernel.Tests.Implementations {
    ...
    public class FailureMechanismResultAssemblerTests {
        ...
        private readonly AssessmentSection assessmentSectionAmeland = new AssessmentSection(20306, 1.0 / 1000.0, 1.0 / 300.0);
        private readonly FailureMechanism testFailureMechanism1 = new FailureMechanism(14.4, 0.04);

        private readonly AssessmentSection assessmentSectionTest = new AssessmentSection(10000, 1.0 / 3000.0, 1.0 / 300.0);
