    ...
    public class CommonFailurePathSectionAssemblerTests
    {
        ...
        public void DetermineCombinedResultPerCommonSectionReturnsCorrectResults()
        {
            var sectionsList1 = new FailurePathSectionList("", new[]
            {
                ...
                new FailurePathSectionWithCategory(1.5, 2.0, EInterpretationCategory.Gr),
                new FailurePathSectionWithCategory(2.0, 3.0, EInterpretationCategory.III)
            });

            var sectionsList2 = new FailurePathSectionList("", new[]
            {
                new FailurePathSectionWithCategory(0.0, 1.0, EInterpretationCategory.Zero),
                new FailurePathSectionWithCategory(1.0, 1.5, EInterpretationCategory.IMin),
                new FailurePathSectionWithCategory(1.5, 2.0, EInterpretationCategory.IIIMin),
                new FailurePathSectionWithCategory(2.0, 3.0, EInterpretationCategory.II)
            });
            ...
            var expectedResults = new List<FailurePathSectionWithCategory>
            {
                new FailurePathSectionWithCategory(0.0, 1.0, EInterpretationCategory.IIIMin),
                new FailurePathSectionWithCategory(1.0, 1.5, EInterpretationCategory.IMin),
                new FailurePathSectionWithCategory(1.5, 2.0, EInterpretationCategory.Gr),
            ...
            var sectionsList1 = new FailurePathSectionList("", new[]
{
        ...
        #region AssembleCommonFailurePathSections
        [Test]
